...
public class GLObject {
    ...
    /**
     * Creates a {@link com.jayway.oglhelloworld.ogl.GLObject} with {@link #glRenderMode} set
     ...
     * @see com.jayway.oglhelloworld.ogl.GLObject#GLObject(String, VertexType, float[])
     */
